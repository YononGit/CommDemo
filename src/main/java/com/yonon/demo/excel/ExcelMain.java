...
public class ExcelMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            readBusConfigExcel(file);
            readTransactionConfigExcel(file);
            readTransactionAccountExcel(file);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
     ...
     * 交易栏目 需要添加[] 标志
     **/
    public static void readBusConfigExcel(String file) throws Exception {
        Workbook wb = null;
        String sql = "";
                ...
                for (int rIndex = firstRowIndex; rIndex <= lastRowIndex; rIndex++) {
                    ...
                    if (cell != null) {
                        ...
                        if (StringUtils.isEmpty(cellStr) || snapShot.equals(cellStr)) {
                            ...
                            sql += genBusConfigSql(transCode, name, produceCode, parnerCode).concat("\n");
                            snapShot = cellStr;
                        }
                    } else {
...
//        return list;
    ...
    private static String formatAndWriteSql(String sql, String resultSql,String fileType) {
    ...
    private static String getTransCodePrefix(String content) {
    ...
    private static String getNamePrefix(String content) {
        int beginIndex = 0;
        int endIndex = content.indexOf("[");
    ...
    private static String genBusConfigSql(String transCode, String name, String produceCode, String partnerCode) {
    ...
    public static void readTransactionConfigExcel(String file) throws Exception {
        Workbook wb = null;
        String sql = "";
    ...
    private static String genTransactionConfigSql(String content, String transCode, String partnerCode, String transactionNoPre) {
    ...
    public static void readTransactionAccountExcel(String file) throws Exception {
        Workbook wb = null;
        String sql = "";
     ...
     */
    private static String genTransactionAccountSql(String finName, String content, String transCode, String transactionNoPre, String partnerCode, String direction, String accountCode, Integer reqNo) {
...
//        System.out.println(sql);
     ...
     * 写入文件
     */
    private static void writeFile(String resultSql,String fileType) {
        File file = null;
